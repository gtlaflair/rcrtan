...
```{r}
sub_ex_2 <- subkoviak(data = test_data, items = 10, raw_cut_score = 8, total = 'Total')
```

### phi_domain

The `phi_domain` function calculates Brennan's (1980) short-cut estimate of the generalizability coefficient for absolute decisions.
