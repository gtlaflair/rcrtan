...
* `subkoviak`: This function uses Subkoviak's (1980) methods for estimating kappa and rho from a single test administration.
...
<!-- _n_ is the number of test takers. _k_ is the number of items on the test. _M_~p~ is the mean of the total scores divided by the number of items. _S_~p~^2^ is the variance of the total scores divided by the number of items. $\alpha$ is the coefficient alpha reliability estimate. -->
